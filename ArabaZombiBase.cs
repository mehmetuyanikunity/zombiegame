...
public abstract class ArabaZombiBase
{
    ...
    public float ArabaGucu { get; set; } //Arabayla zombileri ezince, zombi gücü kadar arabanýn gücü düþer.

    public string ZombiTuru { get; set; }

    public float ZombiHizi { get; set; }

    public float ZombiGucu { get; set; } //Araba gücü < zombi gücü = Game Over
